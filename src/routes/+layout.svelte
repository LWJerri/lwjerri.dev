<script lang="ts">
  ...
  import { SITE_ORIGIN } from "../helpers/constants";
...
<svelte:head>
  ...
  <meta property="og:image" content={`${SITE_ORIGIN}/me.webp`} />
  <meta property="og:url" content={canonical} />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="lwjerri.dev" />

  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content={title} />
  <meta name="twitter:description" content={description} />
  <meta name="twitter:image" content={`${SITE_ORIGIN}/me.webp`} />
