...
<div class="flex flex-col justify-between bg-[#0C0E10] scroll-smooth" style="font-family: Monocraft;">
  ...
  <div class="flex text-white flex-col space-y-16 max-w-4xl px-5 mx-auto">
    <div class="space-y-10">
      <div class="flex justify-between font-bold items-center flex-col space-y-2 sm:flex-row sm:space-y-0">
        ...
        <!-- <a class="hover:text-[#ED4245] duration-500 outline-none text-2xl" href="#testOne" id="testOne">[My CV]</a> -->
      </div>
      ...
      <p>
        ...
        >
        Hello, traveler! <span class="text-[#22B8CF]">My name is Andrey, I was born in 2005 in Ukraine</span>, I
        graduated from high school in 11th grade and went to university in Kiev. I started my way to programming in the
        5th grade, when I was playing servers in the popular game Minecraft and I was very curious to know how it all
        worked under the hood. One winter, I was walking with my friend Ilya and told him that I supposedly know how to
      ...
      <p>
        ...
        places through the war, finishing school at another institution. In 2022 I went to the State University of Telecommunications
        in Kyiv to study Software Engineering. While at school I took part in various IT competitions, where I did not take
        a leading place but got a ton of new experience in the team and not only!
      </p>
      ...
      <div class="space-y-10">
        <p>
          ...
          includes a bot and CRM of its own design to facilitate the work of volunteers. The bot performs one of the key
          roles in some records, taking on a heavy workload.
        </p>

        <p>
          The second project is <span class="text-[#22B8CF]">DUTCalendarTracker</span>. A bot developed for my
          university to make it easy to see a list of classes on days specified by the user acts as a reminder of
          classes for the next day notifying me of schedule changes and more. More than 100 people are currently using
          the bot.
        </p>
      </div>
