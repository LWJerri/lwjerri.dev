<script lang="ts">
  ...
  import type { ImageCarousel } from "../../interfaces";
  import Divider from "../ui/Divider.svelte";
  import Section from "./Section.svelte";

  let { imagesCarousel }: { imagesCarousel: ImageCarousel[] } = $props();
</script>
...
<div>
  ...
  <Section title="Hobbies & Interests">
    ...
    {#snippet bodySnippet()}
      <p>
        I spend all my free time at my laptop because my hobby is the same as my main occupation - programming.
        Sometimes I watch informative videos about life, about handcrafts or explaining some things in life. I also
        listen to a lot of music, and learn English and Czech, to be able to express my emotions without any
        restrictions. I love nature, traveling with people close to me, I love atmospheric places and moments in my
        life. I also love to eat, so being able to cook is very important to me, even though I'm not really into it.
      </p>
    {/snippet}
  </Section>
  ...
  <Section title="My Nickname">
    ...
    {#snippet bodySnippet()}
      <p>
        ...
        logged into the game Minecraft, but that day I decided to install the latest version of the game, after which it
        crashed because of an error in the library LWJGL. I sat for a long time, looking at this error and for some
        reason decided to perpetuate it by taking the first three letters from that library - LWJ. This was not enough,
        ...
        made a mistake by writing Jerri instead of Jerry to the prefix "LWJ". That's how the unique nickname LWJerri
        came about.
      </p>
    {/snippet}
  </Section>
